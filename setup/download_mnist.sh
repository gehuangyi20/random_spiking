...
wget -c http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz -O "/tmp/$dir_name"/train-img.gz
wget -c http://yann.lecun.com/exdb/mnist/train-labels-idx1-ubyte.gz -O "/tmp/$dir_name"/train-label.gz
wget -c http://yann.lecun.com/exdb/mnist/t10k-images-idx3-ubyte.gz -O "/tmp/$dir_name"/test-img.gz
wget -c http://yann.lecun.com/exdb/mnist/t10k-labels-idx1-ubyte.gz -O "/tmp/$dir_name"/test-label.gz
