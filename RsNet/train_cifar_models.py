...
data = MNIST(data_dir, data_name, validation_size, model_meta=model_cifar10_meta,
...
if is_trans:
    ...
    trans_model = CIFAR10Model(args.trans_model, None, output_logits=False,
...
if is_distillation:
    ...
    model_teacher = CIFAR10Model(os.path.join(save_model_dir, save_model_name + '_teacher'), None, output_logits=True,
                                 input_data_format=data_format, data_format=data_format, dropout=0,
